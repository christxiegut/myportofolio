...
load_dotenv()
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "angelica-christilia-myportofolio.pws.cs.ui.ac.id"]
...
SECRET_KEY = 'django-insecure-ahqi+9ockmjn^^d+jb6=rfjs#%xxq7r@0v)@&3^so#ol4a=*92'
